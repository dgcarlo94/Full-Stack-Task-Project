...
![Application Main Menu](images/MainMenu.png)
![Employers List](images/EmployersList.png)
![Assigned Task List Sample](images/AssignedTaskList.png)
![Employers Form sample](images/EmployersForm.png)
![Tasks List](images/TasksList.png)
![Task Form Sample](images/TaskForm.png)
![Task Edit Form Sample](images/TaskEdit.png)